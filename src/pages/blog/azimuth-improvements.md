...
*   **Dynamický a kalkulovaný obsah** - šablony mohou obsahovat dynamické prvky, které se automaticky aktualizují na základě zadaných hodnot. Může se jednat například o platební QR kody, marketingové bloky, právní a obchodní podmínky, ale například i tabulky a grafy s modelací průběhu pojištění nebo investice.

<!---->

*   **Dokumentové modely (komponenty) **- šablony mohou obsahovat předem definované části dokumentů, které si může uživatel volit podle potřeb a situace. Modely mohou obsahovat jak texty, tak grafické prvky a jsou dobře využitelné například pro vkládání obchodních podmínek, nebo promo akcí a marketingových sdělení.
